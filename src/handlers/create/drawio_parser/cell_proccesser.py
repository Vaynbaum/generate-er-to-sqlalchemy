from src.handlers.create.drawio_parser.const import TABLE
from src.handlers.create.drawio_parser.field_proccesser import (
    DrawERFieldProccesser,
)
from src.handlers.create.interface import TableFromDiagramSchema
from src.handlers.create.utils import camel_to_snake
